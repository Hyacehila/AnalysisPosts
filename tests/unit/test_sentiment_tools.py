"""
Characterization tests for sentiment_tools.
"""
...
@pytest.mark.parametrize(
    ...
    [
        ...
        if info["category"] == "情感趋势分析" or info["category"] == "焦点窗口分析"
    ]
)
def test_sentiment_tools_run(sample_enhanced_data, tmp_path, tool_name):
