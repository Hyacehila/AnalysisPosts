"""
Characterization tests for interaction_tools.
"""
...
@pytest.mark.parametrize(
    ...
    [
        ...
        if info["category"] == "多维交互分析" or info["category"] == "焦点窗口分析"
    ]
)
def test_interaction_tools_run(sample_enhanced_data, tmp_path, tool_name):
