...
- **子系统文档**:
    - [阶段 1：数据增强子系统](doc/stage1_enhancement.md) — 六维增强、异步并行、Batch API、断点续传
...
- **工具与基础设施**:
    ...
    - [Batch 批处理系统](doc/batch_processing.md) — JSONL 格式、Batch API 工作流、故障恢复
- **测试**:
...
- **灵活调度**: 支持异步并发、Batch API、Agent 自主分析等多种模式。
